...
In our household, we consider video as an individual pursuit, much like reading. The idea of sitting with my partner in our own home, looking at the same screen^[We own no screens that you could watch across a room in any case.] is a little weird. It would be like reading from the same book at the same time.
