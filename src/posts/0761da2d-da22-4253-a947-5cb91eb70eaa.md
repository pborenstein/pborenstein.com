...
The Chat API has a sense of history and can answer indirect questions.^[Chat isn't really doing what it seems to be doing. The reason it has a history is because I'm feeding it [the entire conversation](https://github.com/pborenstein/drafts-gpt-toys/blob/123b16fb59215d1dbe1cfe40b310b9d916c78517/gptchat.js#L106) with each new question.] Here, it infers what "the song" and "the show."
