...
One of the interesting things about the Chat API is that it has a sense of history and can answer indirect questions.^[Like much about large language models, this one isn't really doing what it seems to be doing. The reason it has a history is because I'm feeding it [the entire conversation](https://github.com/pborenstein/drafts-gpt-toys/blob/123b16fb59215d1dbe1cfe40b310b9d916c78517/gptchat.js#L106) with each new question. ]
